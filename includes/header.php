      ...
      <div class="container">
        ...
        <div class="navbar-left">
          ...
          <a class="navbar-brand" href="#">
            <h2 style="color:whitesmoke;">Blu hero</h2>
        ...
        <section class="navbar-mobile">
          ...
          <ul class="nav nav-navbar">
            ...
            <li class="nav-item">
              <a class="nav-link" href="#">Accountants <span class="arrow"></span></a>
              <!-- <nav class="nav">
        ...
        <a class="btn btn-xs btn-round btn-success" href="https://expatpayrollservices.com/app/signin.php">Log In</a>
    ...
    <header class="header text-white h-fullscreen overflow-hidden" style="background-image: linear-gradient(-45deg, #667eea 0%, #764ba2 100%);">
      ...
      <div class="container position-static">
        <div class="row align-items-center h-100">
          ...
          <div class="col-lg-7">
            <h1 class="display-4 fw-500">We actually make <span class="fw-400 pl-2" data-typing="Payroll, and Benefits." data-type-speed="80"></span></h1>
            <p class="lead mt-5 mb-7 mb-md-9 w-80"><strong>It’s time</strong> to tame the chaos of payroll, and benefits.</p>
            <a class="btn btn-xl btn-round btn-success w-200 mr-3 px-6 d-none d-md-inline-block" href="https://expatpayrollservices.com/app/signin.php">Log In</a>
            <a class="btn btn-xl btn-round btn-outline-light w-200 px-6" href="#">Contact us</a>
          </div>
